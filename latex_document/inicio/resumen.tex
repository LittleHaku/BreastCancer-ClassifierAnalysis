Esta 
tesis \ab{mejor llamarlo Trabajo de Fin de Grado, que es lo que es ;)}
...
IA \ab{aunque es un término común, no está explicado, y como solo se utiliza una vez en el resumen, no usaría el acrónimo sino el nombre completo}
para fines médicos.
...
\ab{lo mismo en las palabras clave: no pondría IA sino Inteligencia Artificial}