...
it into a 70\% training set and a 30\% test set. \ab{is this important? I mean, you probably implemented so that it could take different percentages, right? I have not read the rest, but it is always better to present the implementation as general as possible, and later, in the experiments, you can specify any parameter that was left out in the explanation, I don't know if you know what I mean... -- if you agree, my suggestion would be to put it as 'splitting into training and test sets'}
...
An example of a \ac{fnab} is shown in Figure \ref{FIG:FNAB}. \ab{this sentence appears out of nowhere -- it probably fits better before the sentence 'The dataset is loaded'}
