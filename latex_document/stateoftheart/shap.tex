...
\ab{right now, this is the only subsection in 2.4. This should be avoided, so either you create a section without number (I think a 'paragraph' instead of a subsection would work) or you think if any other subsection could be added under 2.4}
