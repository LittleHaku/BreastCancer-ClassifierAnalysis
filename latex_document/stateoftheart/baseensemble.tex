\ab{perfect, you can ignore my previous comment about ac and acronyms, you are already doing it ;)}
...
Our classifiers will not use the image directly, but rather the features extracted from the images. \ab{I would rephrase this last sentence to something like 'While classifiers may use many different types of information as input, in this work we will focus on exploiting the features extracted from the images, and leave for the future using the image directly.'}
...
Classifiers can be split into two main groups, base classifiers and ensemble classifiers. \ab{a ref here would be good}
...
\ab{perhaps this section could be called '2.1 Basic concepts', and then you could have '2.2 Base classifiers', instead of a subsection of this one}
