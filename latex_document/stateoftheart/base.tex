Base classifiers as just mentioned are single classifiers; \ab{ref?}
they are the simplest form of classifiers, and they are the building blocks of ensemble classifiers. There are many base classifiers, but for this work, we are going to focus on the most common ones. \ab{it could also be good to support why you say these are the most common ones, this is typically done with a reference, if possible to a paper or book}
