...
\ab{but you already mentioned bagging in Random Forest... is it the same? in fact, I know RF can be done via bagging or boosting, it might be better to explain these two briefly in RF, and then here dig deeper in one of them for some (potentially interesting) reason}
